...
public class StepDisplayListSwing extends JPanel {
	...
	@Inject
	public StepDisplayListSwing(ControllerHardware controllerp, EventBus eventBusp, Provider<StepEditorSwing> providerStepEditorSwing, ConfigurationLoader configLoader) {
		super();
